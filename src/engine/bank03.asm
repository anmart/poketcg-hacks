...
HackChangeImakuniBoosters:
	ld bc, $05
	ld hl, OWScript_GiveOneOfEachTrainerBooster.booster_type_table
	ld de, wHackBoosterList
	call CopyDataHLtoDE
	ld a, [wHackSettingsBoosterAdd]
	add 5
	ld e, a
